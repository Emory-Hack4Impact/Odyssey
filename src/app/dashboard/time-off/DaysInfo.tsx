...
const gridstyle = "rounded-md border border-gray-300 p-1 text-center lg:h-32 flex justify-center items-center flex-col"

  return (
    <div className="mx-auto mt-10 w-full p-10 max-w-lg text-black">
