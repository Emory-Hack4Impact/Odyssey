...
const CalendarMini: React.FC<{ events?: CalendarEvent[] }> = ({ events = [] }) => {
...
// ---- TimeOffAdmin Component ----

const TimeOffAdmin: React.FC = () => {
  const [selectedDate, setSelectedDate] = useState<string>(toISODate(new Date()));

  const timeOffEvents: CalendarEvent[] = [
    // Format: { date: "YYYY-MM-DD", label: "Employee Name - Leave Type" }
  ...
  return (
    <div className="flex flex-col gap-6 lg:flex-row">
      <div className="lg:w-1/3">
        <CalendarMini events={timeOffEvents} />
      </div>
