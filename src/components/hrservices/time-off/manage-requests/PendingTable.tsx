                ...
                <td className="border-b border-gray-200 px-4 py-2">
                  <div className="flex gap-2">
                    <button
                      ...
                      className="rounded-md bg-green-500 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 disabled:bg-gray-400 disabled:cursor-not-allowed"
                    >
